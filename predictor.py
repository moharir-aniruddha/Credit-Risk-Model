...
MODEL_PATH = 'artifacts_new/model_data_new.joblib'
...
def preprocessing(age, income, loan_amount, loan_tenure_months, average_dpd_per_deliquency,
    ...
    input_data = {
        ...
        'average_dpd_per_deliquency': average_dpd_per_deliquency,
...
def predict(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
    ...
    input_df = preprocessing(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
            delinquency_ratio, credit_utilization_ratio, num_open_accounts,
            residence_type, loan_purpose, loan_type)
